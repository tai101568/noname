    ...
    $.sprFlat = function(element, options) {
        ...
        var defaults = {
            ...
            backToTop: {
                ...
                imgsrc: '../../ui/cms/sprflat/assets/img/backtop.png', //image 
        ...
        plugin.panels = function () {
            ...
            panelControlsLink.click(function(e) {
                ...
                if (self.hasClass('panel-refresh')) {
                	thisPanel.trigger("panelRefresh")
...
//                    }, 3000);
        ...
        plugin.checkAndRadios = function(themeColor, parentEl) {
