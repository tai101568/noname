...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  ...
                  if (options.showRangeInput === true) {
                	  DRPTemplate +=
        ...
        this.element.attr('readonly') == null && this.element.on('keyup', $.proxy(this.updateFromControl, this));
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            this.container.find('.calendar.left').html('<h5>' + this.locale.fromLabel + '</h5>' + this.renderCalendar(this.leftCalendar.calendar, this.startDate, this.minDate, this.maxDate));
            this.container.find('.calendar.right').html('<h5>' + this.locale.toLabel + '</h5>' + this.renderCalendar(this.rightCalendar.calendar, this.endDate, this.startDate, this.maxDate));
